# Ollama Workflow Evaluation - ollama-all-llm
...
| --- | --- | --- | --- | ---: | --- |
| 1 | ResumeParseAgent | mock |  | 0.215 | 识别技能 12 个，项目 2 个。 |
| 2 | JDAnalysisAgent | llm |  | 16071.836 | 使用 LLM JD 分析 必备技能 4 个。 |
| 3 | MatchAgent | mock |  | 1.606 | 生成匹配报告，总分 27.0。 |
| 4 | ResumeOptimizeAgent | llm |  | 146049.786 | 使用 LLM 简历优化 生成 4 条 JD 定向建议。 |
| 5 | ProjectInterviewAgent | fallback | LLMServiceError | 180015.624 | LLM 项目追问失败，已回退 mock（LLMServiceError） |
| 6 | ReportAgent | mock |  | 0.320 | 聚合结构化结果并生成 Markdown 报告。 |
...
| ResumeOptimizeAgent | 3273 | 1924 | 5197 | llm |  | 2970 | 1632 | 4602 |
| ProjectInterviewAgent | 1466 | 1866 | 3332 | fallback | LLMServiceError |  |  |  |
...
- jd_targeted_bullets_count: 4
- missing_info_needed: 缺少结果或量化亮点
- do_not_exaggerate: None
...
- ResumeOptimizeAgent produced 6 rewrite suggestions and 4 JD-targeted bullets.
...
- Estimated total tokens for the three LLM-capable agents: 9568.
...
- 在技能栏中明确列出 Python、FastAPI、Pydantic 等技术栈，以及相关的项目经验。
- 为每个项目添加具体的成果和效果描述，如项目 1 中的 Markdown 报告生成器。
