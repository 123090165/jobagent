...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- |
| 1 | ResumeParseAgent | mock |  | 1.691 |  |  |  |  | 识别技能 12 个，项目 2 个。 |
| 2 | JDAnalysisAgent | mock |  | 0.596 |  |  |  |  | 使用 mock JD 规则分析 必备技能 9 个。 |
| 3 | MatchAgent | mock |  | 0.715 |  |  |  |  | 生成匹配报告，总分 77.0。 |
| 4 | ResumeOptimizeAgent | mock |  | 0.237 |  |  |  |  | 使用 mock 简历优化 生成 2 条 JD 定向建议。 |
| 5 | ProjectInterviewAgent | llm |  | 38484.749 | 6 | 0 | project_question_generator_v1 |  | 使用 LLM 项目追问 |
| 6 | ReportAgent | mock |  | 0.215 |  |  |  |  | 聚合结构化结果并生成 Markdown 报告。 |
...
| ProjectInterviewAgent | 1779 | 1427 | 3206 | llm |  | 1336 | 598 | 1934 |
...
- Estimated total tokens for the three LLM-capable agents: 7488.
...
- **Question**: 请描述你在项目 1 中如何使用 AI Agent 技术来匹配简历和 JD，以及你在这个过程中遇到的挑战和解决方案。
  - Evaluates: 为了评估你的实际应用能力和解决问题的能力。
  - Answer framework: AI Agent 技术的理解和实现; 简历和 JD 匹配系统的开发过程; 面对挑战时的解决方案
