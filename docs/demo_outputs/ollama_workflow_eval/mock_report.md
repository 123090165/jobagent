...
| --- | --- | --- | --- | ---: | --- |
| 1 | ResumeParseAgent | mock |  | 1.274 | 识别技能 12 个，项目 2 个。 |
| 2 | JDAnalysisAgent | mock |  | 0.530 | 使用 mock JD 规则分析 必备技能 9 个。 |
| 3 | MatchAgent | mock |  | 0.679 | 生成匹配报告，总分 77.0。 |
| 4 | ResumeOptimizeAgent | mock |  | 0.240 | 使用 mock 简历优化 生成 2 条 JD 定向建议。 |
| 5 | ProjectInterviewAgent | mock |  | 0.101 | 使用 mock 项目追问 |
| 6 | ReportAgent | mock |  | 0.105 | 聚合结构化结果并生成 Markdown 报告。 |
