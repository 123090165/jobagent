...
finance_fa_analysis | strong | strong | LLM path produced usable suggestion decisions without increasing confirmed coverage. | No notable LLM-specific risk increase. | keep deterministic as default review baseline
...
anker_ai_health_algorithm | strong | strong | No meaningful LLM improvement observed. | No notable LLM-specific risk increase. | keep deterministic as default review baseline
