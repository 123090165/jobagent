# Mixed Chinese and English resume
...
- parsed_skills: Python, FastAPI, SQLite, Streamlit, Git
- parsed_project_count: 1
- parsed_work_experience_count: 2
- parsed_education_count: 1
- parsed_highlights: Target Roles: Backend Engineer / Research Engineer, 完成 120 tests，并整理 evaluation notes。, Research Assistant, Vision Lab, Built experiment tooling and dataset scripts in Python., 图像检索系统：使用 FastAPI、SQLite 和 Streamlit 搭建 demo，负责接口设计与测试。

## Profile draft summary
- draft: {"skill_count": 5, "project_count": 1, "work_experience_count": 2, "education_count": 1, "highlight_count": 5, "target_roles": ["Backend Engineer", "Research Engineer"]}
...
- enrichment_discarded_suggestion_count: 2
...
## Reviewer notes
- accepted 1 grounded suggestions
- discarded 2 unsupported enrichment suggestions
