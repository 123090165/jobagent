...
- baseline_quality_warnings: project evidence may be too thin for matching
- baseline_missing_info_questions: For your strongest project, what exactly did you build, which technologies did you use, and what measurable result can you show?
- parsed_skills: Python, FastAPI, Streamlit, SQLite, Git, Pandas, NumPy, PyTorch, Librosa, 数据分析
...
- draft: {"skill_count": 10, "project_count": 2, "work_experience_count": 2, "education_count": 1, "highlight_count": 2, "target_roles": ["AI Agent Intern", "Backend Engineer Intern", "Data Analyst Intern"]}
...
- enrichment_quality_warnings: project evidence may be too thin for matching, discarded ungrounded profile enrichment suggestion
...
- confirmed_remaining_warnings: project evidence may be too thin for matching
...
## Reviewer notes
- missing expected skills: MFCC, STFT, CNN
