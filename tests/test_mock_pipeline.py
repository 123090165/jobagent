...
SAMPLE_RESUME = """
Zhang San
Skills: Python, FastAPI, Pydantic, Streamlit, SQL, Git
Project: JobAgent analysis tool using Streamlit and Pydantic to generate a structured match report.
Responsibilities: designed the mock pipeline and generated Markdown reports.
"""

SAMPLE_JD = """
AI Application Engineer
Responsibilities: build Python backend services, design REST APIs, and support AI application delivery.
Requirements: Python, FastAPI, SQL, Pydantic, and Git experience.
Preferred: RAG, LangGraph, Docker.
"""
...
def test_run_mock_pipeline_returns_structured_report() -> None:
    ...
    assert "- Interview challenge:" in result.markdown_report
