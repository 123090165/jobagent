...
def test_create_profile_session_returns_v4_resource() -> None:
    ...
    assert payload["current_step"] == "resume_intake"
...
def test_get_profile_session_returns_existing_session() -> None:
...
def test_get_unknown_profile_session_returns_404() -> None:
